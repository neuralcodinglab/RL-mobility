    ...
    public class Player : MonoBehaviour
    {
        ...
        public void Move(int action)
        {
            ...
            switch (action)
            {
                case 0: // forward
                    {
                        transform.position = currentPos + transform.forward * appData.ForwardSpeed;// currentPos + new Vector3(0f, 0f, appData.ForwardSpeed);
                ...
                case 1: // agent wants to go left
                    {
                        transform.Rotate(new Vector3(0f, -15.0f, 0f));
                        /*
